...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach(animal => {
      arr.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`)
    }); 
    return arr;
  }
  ...
  */
  ...
  function lowerCaseNames(animalNames){
    let names = animalNames.map(animal => animal.animal_name.toLowerCase());
    return names;
  }
console.log(lowerCaseNames);
  ...
  */
  ...
  function lowPopulationAnimals(animals){
    /*Your Code Here*/
    const result = animals.filter(animal => animal.population < 5)
    return result;
  }
  ...
  */
  ...
  function USApop(animals){
    /*Your Code Here*/
    const population = animals.reduce((accumulator, animal) => animal.population + accumulator, 0)
    return population;
  }
